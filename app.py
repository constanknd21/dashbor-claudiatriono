...
def load_data():
    try:
        df = pd.read_csv('data_psu.csv', delimiter=',', on_bad_lines='skip', lineterminator='\n', quoting=csv.QUOTE_NONE)
...
if not df.empty and 'sentiment_name' in df.columns:
    ...
    st.error("⚠️ Dataset tidak ditemukan. Pastikan file 'data_psu.csv' berada di direktori yang sama.")
else:
